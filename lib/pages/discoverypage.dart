    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('الاخبار اليومية',style: TextStyle(fontSize: 15,color: ToolsUtilities.whiteColor,)),
          Text('اكتشف الان',style: TextStyle(fontSize: 30,color: ToolsUtilities.whiteColor,fontWeight: FontWeight.bold),),
